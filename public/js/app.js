...
ready(function () {
  var createProduct = document.getElementById("create_product").addEventListener('click', function (event) {
  ...
  var product = {
    createProduct: function createProduct(data) {
      window.axios.post('/product', data).then(function (response) {
...
window.axios.defaults.baseURL = 'http://' + window.location.hostname + ":" + location.port + '/api';
/**
